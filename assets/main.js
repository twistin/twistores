...
// Call this to get the HTML for the social links row.
// Update the hrefs below when actual profiles are available.
function buildSocialLinks(className = 'social-links') {
    const profiles = [
        { key: 'instagram',    href: 'https://instagram.com/',    label: 'Instagram' },
        { key: 'twitter',      href: 'https://x.com/',           label: 'X / Twitter' },
        ...
        { key: 'researchgate', href: 'https://researchgate.net/',label: 'ResearchGate' },
    ];
